...
setup(
    name='topology_docker_oobmhost',
    version=find_version('lib/topology_docker_oobmhost/__init__.py'),
    package_dir={'': 'lib'},
    ...
    url=(
        ...
        'topology_docker_oobmhost/tree/master/doc'
    ),
    keywords='topology_docker_oobmhost',
    ...
    entry_points={
        'topology_docker_node_10': [
            'oobmhost = topology_docker_oobmhost.oobmhost:OobmHostNode'
        ]
    }
)
